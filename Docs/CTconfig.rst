...
The good news is that MonELOG supports a wide variety of readily available 
...
The 3.5mm connectors plug into any of the 14 input channels on the MonELOG.
...
**Allow negative power value**
    ...
    grid-tied solar (net-metering).  Checking this box tells MonELOG 
...
**Reverse**
    ...
    is a necessity in three-phase installations because the MonELOG 
...
Each time you press save, the new configuration is sent to MonELOG 
...
When you have configured all of the CTs connected to the MonELOG, 
basic configuration is complete.
Click the |Status| button to see the MonELOG in action.
...
Current type CTs are the most common type of CT used with MonELOG and
all of the CTs available in the MonELOG *Stuff* Store are of this type. 
...
voltage rather than current.  They are connected to a modified MonELOG 
